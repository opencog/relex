...
# Link Grammar
wget http://www.abisource.com/downloads/link-grammar/5.0.4/link-grammar-5.0.4.tar.gz
tar -xvf link-grammar-5.0.4.tar.gz
rm link-grammar-5.0.4.tar.gz
cd link-grammar-5.0.4
