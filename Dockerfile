...
# Link Parser
RUN (curl -O http://www.abisource.com/downloads/link-grammar/5.0.4/link-grammar-5.0.4.tar.gz)
RUN (tar zxvf link-grammar-5.0.4.tar.gz; cd link-grammar-5.0.4/; ./configure; make; sudo make install; ldconfig)
