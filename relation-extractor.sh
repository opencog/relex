...
java $VM_OPTS $RELEX_OPTS $CLASSPATH relex.RelationExtractor -n 4 -l -t -a --or --stanford --penn -s  "
Anyone who is afraid of doing too much will end up doing to little."
